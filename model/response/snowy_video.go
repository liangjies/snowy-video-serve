...
type ShowVideoResponse struct {
	...
	IsShowimage           bool      `json:"isShowimage" gorm:"column:isShowimage"`                     // APP
	IsShowProgressBarTime bool      `json:"isShowProgressBarTime" gorm:"column:isShowProgressBarTime"` // APP
}
